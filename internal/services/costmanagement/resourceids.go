...
//go:generate go run ../../tools/generator-resource-id/main.go -path=./ -name=ManagementGroupCostManagementView -id=/providers/Microsoft.Management/managementGroups/12345678-1234-9876-4563-123456789012/providers/Microsoft.CostManagement/views/view1
